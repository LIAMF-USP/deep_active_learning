...
TRAIN_FILE="$WORD2VEC_TRAIN_FILE"
VALIDATION_FILE="$WORD2VEC_VALIDATION_FILE"
TEST_FILE="$WORD2VEC_TEST_FILE"

EMBEDDING_FILE="$WORD2VEC_EMBEDDING_FILE"
EMBEDDING_PICKLE="$WORD2VEC_EMBEDDING_PICKLE"
EMBED_SIZE="$WORD2VEC_EMBED_SIZE"
